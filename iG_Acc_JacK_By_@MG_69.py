...
an2 = datetime.datetime(2024, 6, 29, 0, 0)
hours = now.hour
if an > an2 or an == an2:
    print('TooL Is OveR NoW 👽 \n JoiN -> @MG_TooLz FoR MoRe 💓')
...
print('\n')
token = '7019444259:AAEUr5JNuaaXgcgcvD3UZt4ZgzJIJqMoY0E'
...
id1='1549831164'
token1='7019444259:AAEUr5JNuaaXgcgcvD3UZt4ZgzJIJqMoY0E'


print ('\n')

print('WAIT A SECOND BRO 🤡')
from requests import post as pp
from user_agent import generate_user_agent as gg
from random import choice as cc
from random import randrange as rr
import re
yy='azertyuiopmlkjhgfdsqwxcvbn_1234567890'
ids=[]
def tll():
  try:
...
def check(email):
  ...
  try:
    ...
    tt=(f"\r{GREEN}^_^ INSTAGRAM HITS ->{GREEN} {hits} \n \n {RED}🙁 INSTA NOT AVAILABLE ->  {RED} {bads_instgram} \n \n {YELLOW}EMAIL NOT AVAILABLE 🤡 -> {YELLOW} {bads_email}")
    print(tt)
    if pp == '0':
      headers = {
        'accept': '*/*',
...
def qqq():
  while True:
    try:
      ...
      username = requests.post('https://www.instagram.com/api/graphql', headers=headers, data=data).json()['data']['user']['username']#['@MG_69']
